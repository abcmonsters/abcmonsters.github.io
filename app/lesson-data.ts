...
export const SCENES = [
  ...
  ['Vườn bướm', 'garden'],
  ['Thành phố mèo', 'city'],
  ['Đảo khủng long', 'jungle'],
  ['Đồi đại bàng', 'mountain'],
  ['Hồ ếch xanh', 'water'],
  ['Thảo nguyên', 'savanna'],
  ['Bến trực thăng', 'city'],
  ['Vương quốc băng', 'snow'],
  ['Biển sứa', 'water'],
  ['Thung lũng diều', 'sky'],
  ['Vườn chanh', 'garden'],
  ['Rừng ánh trăng', 'night'],
  ['Rừng tổ chim', 'forest'],
  ['Đại dương cam', 'water'],
  ['Đảo chim cánh cụt', 'snow'],
  ['Lâu đài nữ hoàng', 'castle'],
  ['Trạm tên lửa', 'space'],
  ['Sa mạc mặt trời', 'desert'],
  ['Đường tàu hổ', 'jungle'],
  ['Xứ sở kỳ lân', 'sky'],
  ['Núi lửa âm nhạc', 'volcano'],
  ['Vịnh cá voi', 'water'],
  ['Hang pha lê', 'crystal'],
  ['Đỉnh núi Yak', 'mountain'],
  ['Đồng cỏ ngựa vằn', 'savanna'],
] as const;
